...
urlpatterns = [
    ...
    url(r'^view-applications/update/(?P<pk>\d+)/$' , views.ViewApplicationUpdateView.as_view() , name="update-applications"),
    url(r'^view-applications/delete/(?P<pk>\d+)/$' , views.ViewApplicationDeleteView.as_view() , name="delete-applications")
]
